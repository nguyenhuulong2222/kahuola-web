...
- [x] **P27c · Water Quality map layer** — `DONE` (2026-09-16),
  ...
  **P27e (2026-09-17) — brown water explainer.** One collapsed line,
  ...
  ⚠ COPY PENDING OWNER APPROVAL: the approved text was not supplied with the
  task, so `ocean.wq_explainer_{title,body,short}` currently carry DOH's own
  advisory language. Swap those three keys (EN+VI) before treating as final.
...
- 2026-09-17 — P27e shipped: brown water explainer (collapsed card line +
  ...
  copy is DOH-derived and awaits owner approval.
