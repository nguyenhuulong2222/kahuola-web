...
(function () {
  ...
  var LOCALES = {
    ...
    haw: {
      ...
      "map.loading_aggregator": KEEP_ENGLISH,
      "map.please_wait": "E kali\u2026",
      "map.refreshing": KEEP_ENGLISH,
      "map.locating": KEEP_ENGLISH,
      "map.snapshot_waiting": KEEP_ENGLISH,
      "map.fetching_data": KEEP_ENGLISH,
      "map.footer_live": "Kahu Ola \xb7 Kaiaulu \xb7 Live",
      "map.footer_local": "Kahu Ola \xb7 Kaiaulu",
      "map.hide_details": KEEP_ENGLISH,
      "map.open_full_map": KEEP_ENGLISH,
      "map.dark_map": KEEP_ENGLISH,
      "map.basemap_dark": KEEP_ENGLISH,
      "map.view_statewide": KEEP_ENGLISH,
      "map.view_my_location": KEEP_ENGLISH,
      ...
      "map.chip_privacy": KEEP_ENGLISH,
      "map.blueprint_footnote": KEEP_ENGLISH,
      "map.mini_map_title": KEEP_ENGLISH,
      "map.mini_map_desc": KEEP_ENGLISH,
      "map.banner_degraded": KEEP_ENGLISH,
      "map.banner_loc_denied": KEEP_ENGLISH,
      "map.banner_location": KEEP_ENGLISH,
      "map.banner_offline": KEEP_ENGLISH,
      "map.banner_parse_error": KEEP_ENGLISH,
      "map.layer_smoke": KEEP_ENGLISH,
      "map.layer_rain_radar": KEEP_ENGLISH,
      "map.layer_perimeters": KEEP_ENGLISH,
      "map.layer_mrms": KEEP_ENGLISH,
      "map.layer_fire_weather": KEEP_ENGLISH,
      "map.layer_flood_context": KEEP_ENGLISH,
      "map.layer_landslide": KEEP_ENGLISH,
      "map.layer_local_reports": KEEP_ENGLISH,
      "map.accordion_hazards": KEEP_ENGLISH,
      "map.accordion_context": KEEP_ENGLISH,
      "map.accordion_secondary": KEEP_ENGLISH,
      "map.accordion_evidence": KEEP_ENGLISH,
      "map.accordion_snapshot": KEEP_ENGLISH,
      "map.accordion_snapshot_sub": KEEP_ENGLISH,
      "map.detail_kicker": KEEP_ENGLISH,
      "map.detail_title_default": KEEP_ENGLISH,
      "map.detail_label_status": KEEP_ENGLISH,
      "map.detail_label_context": KEEP_ENGLISH,
      "map.detail_label_design": KEEP_ENGLISH,
      ...
      "map.s_active": KEEP_ENGLISH,
      "map.s_clear": KEEP_ENGLISH,
      "map.s_unavailable": KEEP_ENGLISH,
      "map.s_none": KEEP_ENGLISH,
      "map.s_off": KEEP_ENGLISH,
      "map.s_inactive": KEEP_ENGLISH,
      ...
      "map.s_perim_none_badge": KEEP_ENGLISH,
      ...
      "map.metric_detections": KEEP_ENGLISH,
      "map.metric_fetched": KEEP_ENGLISH,
      "map.metric_nearest": KEEP_ENGLISH,
      "map.source_colon": KEEP_ENGLISH,
      "map.updated_colon": KEEP_ENGLISH,
      "map.ref_label_you": KEEP_ENGLISH,
      "map.ref_label_view": KEEP_ENGLISH,
      ...
      "map.popup_title_mrms": KEEP_ENGLISH,
      "map.popup_title_smoke": KEEP_ENGLISH,
      ...
      "map.popup_acquired": KEEP_ENGLISH,
      "map.popup_frp": KEEP_ENGLISH,
      "map.popup_freshness": KEEP_ENGLISH,
      "map.popup_dist_from_you": KEEP_ENGLISH,
      "map.popup_details": KEEP_ENGLISH,
      "map.popup_city": KEEP_ENGLISH,
      "map.popup_county": KEEP_ENGLISH,
      "map.popup_area": KEEP_ENGLISH,
      ...
      "map.popup_reported_at": KEEP_ENGLISH,
      "map.popup_observed_at": KEEP_ENGLISH,
      "map.popup_detected_time": KEEP_ENGLISH,
      "map.popup_official_report": KEEP_ENGLISH,
      "map.popup_open_directions": KEEP_ENGLISH,
      "map.popup_your_location": KEEP_ENGLISH,
      ...
      "map.smoke_on": KEEP_ENGLISH,
      "map.smoke_off": KEEP_ENGLISH,
      "map.smoke_layer_note": KEEP_ENGLISH,
      "map.weather_on": KEEP_ENGLISH,
      "map.weather_off": KEEP_ENGLISH,
      "map.perimeters_on": KEEP_ENGLISH,
      "map.perimeters_off": KEEP_ENGLISH,
      ...
      // ── Long-copy sections: all KEEP ENGLISH ─────────────────────
      "gs.label": KEEP_ENGLISH, "gs.lead": KEEP_ENGLISH,
      "gs.title_l1": KEEP_ENGLISH, "gs.title_l2": KEEP_ENGLISH,
      "gs.web_badge": KEEP_ENGLISH, "gs.web_title": KEEP_ENGLISH,
      ...
      "gs.web_cta": KEEP_ENGLISH, "gs.mobile_badge": KEEP_ENGLISH,
      "gs.mobile_title": KEEP_ENGLISH, "gs.mobile_desc": KEEP_ENGLISH,
      "gs.mobile_li1": KEEP_ENGLISH, "gs.mobile_li2": KEEP_ENGLISH,
      "gs.mobile_li3": KEEP_ENGLISH, "gs.mobile_li4": KEEP_ENGLISH,
      "gs.mobile_cta": KEEP_ENGLISH,
      "how.label": KEEP_ENGLISH, "how.lead": KEEP_ENGLISH,
      "how.title_l1": KEEP_ENGLISH, "how.title_l2": KEEP_ENGLISH,
      "how.step1_title": KEEP_ENGLISH, "how.step1_body": KEEP_ENGLISH,
      "how.step2_title": KEEP_ENGLISH, "how.step2_body": KEEP_ENGLISH,
      "how.step3_title": KEEP_ENGLISH, "how.step3_body": KEEP_ENGLISH,
      "infra.label": KEEP_ENGLISH, "infra.lead": KEEP_ENGLISH,
      "infra.title_l1": KEEP_ENGLISH, "infra.title_l2": KEEP_ENGLISH,
      "infra.note": KEEP_ENGLISH,
      "mission.label": KEEP_ENGLISH, "mission.lead": KEEP_ENGLISH,
      "mission.title_l1": KEEP_ENGLISH, "mission.title_l2": KEEP_ENGLISH,
      "mission.body": KEEP_ENGLISH, "mission.chip_fire": KEEP_ENGLISH,
      "mission.chip_grant": KEEP_ENGLISH, "mission.chip_privacy": KEEP_ENGLISH,
      "mission.chip_resilience": KEEP_ENGLISH,
      "mission.val1_title": KEEP_ENGLISH, "mission.val1_body": KEEP_ENGLISH,
      "mission.val2_title": KEEP_ENGLISH, "mission.val2_body": KEEP_ENGLISH,
      "mission.val3_title": KEEP_ENGLISH, "mission.val3_body": KEEP_ENGLISH,
      "mission.val4_title": KEEP_ENGLISH, "mission.val4_body": KEEP_ENGLISH,
      "privarch.label": KEEP_ENGLISH, "privarch.lead": KEEP_ENGLISH,
      "privarch.title": KEEP_ENGLISH,
      "privarch.card1_title": KEEP_ENGLISH, "privarch.card1_body": KEEP_ENGLISH,
      "privarch.card2_title": KEEP_ENGLISH, "privarch.card2_body": KEEP_ENGLISH,
      "privarch.card3_title": KEEP_ENGLISH, "privarch.card3_body": KEEP_ENGLISH,
      "privarch.footnote_prefix": KEEP_ENGLISH, "privarch.footnote_link": KEEP_ENGLISH,
      "transparency.title": KEEP_ENGLISH, "transparency.copy": KEEP_ENGLISH,
    ...
    tl: {
      ...
      "context.rain_moderate": KEEP_ENGLISH, "context.rainfall": KEEP_ENGLISH,
      ...
      "signal.detail_flood": KEEP_ENGLISH, "signal.detail_label": KEEP_ENGLISH,
      "signal.fire_copy_active_tmpl": KEEP_ENGLISH,
      "signal.fire_copy_monitoring_long": KEEP_ENGLISH,
      "signal.fire_title_active": KEEP_ENGLISH,
      "signal.flood_copy_active_tmpl": KEEP_ENGLISH,
    ...
    ilo: {
      ...
      "map.s_smoke_none": KEEP_ENGLISH, "map.s_smoke_det_note_1": KEEP_ENGLISH,
      ...
      "map.s_perim_none_badge": KEEP_ENGLISH, "map.s_perim_none_note": KEEP_ENGLISH,
      ...
      "map.s_hurricane_none_note": KEEP_ENGLISH, "map.s_landslide_context": KEEP_ENGLISH,
      ...
      "map.wind_note_init": KEEP_ENGLISH, "map.mrms_note_init": KEEP_ENGLISH,
      "map.radar_note_init": KEEP_ENGLISH, "map.local_note_init": KEEP_ENGLISH,
      "map.wait_smoke": KEEP_ENGLISH, "map.wait_perim": KEEP_ENGLISH,
      ...
      "freshness.delayed": KEEP_ENGLISH, "footer.follow": KEEP_ENGLISH,
      "context.fire_weather": KEEP_ENGLISH, "context.flood_none_active": KEEP_ENGLISH,
      "context.flood_risk": KEEP_ENGLISH, "context.flood_warning_active": KEEP_ENGLISH,
      "context.flood_watch_active": KEEP_ENGLISH, "context.nexrad_mrms": KEEP_ENGLISH,
      "context.none": KEEP_ENGLISH, "context.nws_official": KEEP_ENGLISH,
      ...
      "delta.new_fires": KEEP_ENGLISH, "delta.no_change": KEEP_ENGLISH,
      "delta.status_changed": KEEP_ENGLISH,
      "signal.check_neighborhood": KEEP_ENGLISH, "signal.detail_all_clear": KEEP_ENGLISH,
      "signal.detail_fire_count": KEEP_ENGLISH, "signal.detail_flood": KEEP_ENGLISH,
      "signal.detail_label": KEEP_ENGLISH, "signal.fire_copy_active_tmpl": KEEP_ENGLISH,
